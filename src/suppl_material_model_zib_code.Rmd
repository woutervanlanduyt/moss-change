...
full_model_zib <- brm(bf(n_hok_2000_2019 | trials(n_hok_tot_2000_2019) + weights(wei) ~ 
...
broom.mixed::tidy(model_zib_2) %>%
  kable(digits = 2, caption = "Parameter estimates for the zero-inflated (component = zi) and binomial part (component = cond) of the final model.")
```
